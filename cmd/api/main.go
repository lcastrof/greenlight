...
func main() {
	...
	// We default to using the port number 4000 and the environment "development"
	...
	// Declare a new servemux and add a /vq/healthcheck route which dispatches
	...
	// on the port provided in the config struct and uses the servemux we created
	// above as the handler
	srv := &http.Server{
